...
<body>
    ...
    <main>
        <div class="profile-card">
            ...
            <!-- Saludo y Bio -->
            <h1>Hola, aki ponen el identificador nombre. !</h1>
            ...
            <div class="info-box">
                ...
                <div class="info-list">
                    <div class="info-item">
                        ...
                        <span><span class="info-label">Nombre:</span> <span class="info-value"> @user</span></span>
                    </div>
                    <div class="info-item">
                        <svg viewBox="0 0 24 24"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg>
                        <span><span class="info-label">Turno:</span> <span class="info-value">@turno</span></span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <span><span class="info-label">Semestre:</span> <span class="info-value">@semestre</span></span>
                    </div>
